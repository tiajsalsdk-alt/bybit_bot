...
def get_signal(df: pd.DataFrame, htf_adx: float, htf_ema: float, symbol: str = "Unknown") -> tuple[str, str] | None:
    """
    htf_adx >= 24: 로직 1 (SMC Sniper + 얕은 눌림목)
    htf_adx <= 23: 로직 2 (볼벤 + StochRSI 비대칭 하이브리드)
    """
